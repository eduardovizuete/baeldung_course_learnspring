package com.baeldung.taskmanagementapplesson.aspect;
...
public class ProjectServiceAspect {
    ...
    @Before("execution(* com.baeldung.taskmanagementapplesson.service.impl.ProjectServiceImpl.findById(Long))")
    public void before(JoinPoint joinPoint) {
        LOG.info("Searching Project with Id {}", joinPoint.getArgs()[0]);
    }

    @After("within(com.baeldung.taskmanagementapplesson.service.impl.ProjectServiceImpl)")
    ...
    @Around("execution(* com.baeldung.taskmanagementapplesson.service.impl.ProjectServiceImpl.save(*))")
